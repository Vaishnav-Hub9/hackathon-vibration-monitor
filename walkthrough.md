...
- **Python ML Server Update:** The `/predict` endpoint in `server.py` now leverages the `openai` Python package to generate an AI technician summary based on the scikit-learn 6-class prediction (Healthy / Imbalance / Misalignment / Ball / Inner Race / Outer Race) and FFT telemetry.
